...
export default function Login(props) {
  ...
  async function mainLogin() {
    var emailInput = document.getElementById("emailInputBox").value;
    ...
    const { data } = await axios.post(
      ...
      "https://careercraft.pythonanywhere.com/api/v1/token/obtain",
    ...
    if (data.success === "true") {
      ...
      document.getElementById("alertBox").style.opacity = "1";
      document.getElementById("alertBox").innerHTML = "No User Found.";
      props.setProgress(100);
    }
  }
  ...
  return (
    <div id="loginWindowMainFrame">
      <center>
        <div id="loginBox" className="card hidden" ref={myRef}>
          <h2
